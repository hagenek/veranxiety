defmodule VeranxietyWeb.SessionLiveTest do
  use VeranxietyWeb.ConnCase

  import Phoenix.LiveViewTest
  import Veranxiety.TrainingFixtures

  @create_attrs %{success: true, duration: 42, notes: "some notes"}
  @update_attrs %{success: false, duration: 43, notes: "some updated notes"}
  @invalid_attrs %{success: false, duration: nil, notes: nil}
